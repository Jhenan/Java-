...
public class Lottery extends JFrame {
	...
	public Lottery() {
		...
		JButton btn_confirm = new JButton("\u96FB\u9078");
		...
		btn_confirm.setBounds(388, 56, 62, 39);
		...
		btn_go.setBounds(512, 148, 62, 39);
		panel.add(btn_go);
		...
		scrollPane.setBounds(300, 243, 362, 353);
